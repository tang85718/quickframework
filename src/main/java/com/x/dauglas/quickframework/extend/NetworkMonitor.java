...
public class NetworkMonitor {
    ...
    /**
     * In case of a Disconnect, the connectivity manager may have already established,
     * or may be attempting to establish, connectivity with another network.
     * If so, {@code mOtherNetworkInfo} will be non-null.
     */
